...
def showStudent(list):
        ...
        table.setItem(0, 0, QTableWidgetItem("College Roll"))
        table.setItem(0, 1, QTableWidgetItem(str(roll)))
        table.setItem(1, 0, QTableWidgetItem("Full Name"))
        ...
        table.setItem(4, 0, QTableWidgetItem("Current Year"))
        table.setItem(4, 1, QTableWidgetItem(str(year)))
        table.setItem(5, 0, QTableWidgetItem("Academic Year (From Starting)"))
        table.setItem(5, 1, QTableWidgetItem(str(academic_year)))
        table.setItem(6, 0, QTableWidgetItem("Permanent Address"))
        table.setItem(6, 1, QTableWidgetItem(str(address)))
        table.setItem(7, 0, QTableWidgetItem("Parent Mobile No"))
...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.btnEnterPaymentFont.setPointSize(8)
        ...
        self.btnShowPaymentDetailsFont.setPointSize(8)
