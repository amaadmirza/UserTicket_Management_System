...
class TicketWindow(QDialog, userInterface):
    ...
    def paymentSaveWindow(self):
        ...
        if (_age == "Less than 15"):
            ...
            self.totalCost = (int(self._totaltickets)*int(self._price))-(int(self.totalCost)*int(self._totaltickets))
    ...
    def nextWindow(self):
        ...
        self.PaymentWindow = PaymentWindow(self.UID,self.username, _totalCost, _totaltickets)
